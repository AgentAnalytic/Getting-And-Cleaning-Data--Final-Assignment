...
data_mean_std <- rename(data_mean_std,"activity_code" = "V1")
...
data_mean_std <- rename(data_mean_std,"subject_person_ID" = "V1")


#giving activity_label a descriptive activity names to name the activities in the data set 

activity_label <- rename(activity_label, "activity_type" = "V2")
activity_label <- rename(activity_label, "activity_code" = "V1")
...
data_set <- select(data_set,-activity_code)
